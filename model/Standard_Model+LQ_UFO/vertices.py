...
V_38 = Vertex(name = 'V_38',
              particles = [ P.ta__plus__, P.b, P.r23__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_66})

V_39 = Vertex(name = 'V_39',
              particles = [ P.e__plus__, P.d, P.r23__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_64})

V_40 = Vertex(name = 'V_40',
              particles = [ P.mu__plus__, P.s, P.r23__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_65})

V_41 = Vertex(name = 'V_41',
              particles = [ P.b__tilde__, P.ta__minus__, P.r23 ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_66})

V_42 = Vertex(name = 'V_42',
              particles = [ P.d__tilde__, P.e__minus__, P.r23 ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_64})

V_43 = Vertex(name = 'V_43',
              particles = [ P.s__tilde__, P.mu__minus__, P.r23 ],
              color = [ 'Identity(1,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_65})

V_44 = Vertex(name = 'V_44',
              particles = [ P.g, P.r23__tilde__, P.r23 ],
              color = [ 'T(1,3,2)' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_11})

V_45 = Vertex(name = 'V_45',
              particles = [ P.g, P.g, P.r23__tilde__, P.r23 ],
